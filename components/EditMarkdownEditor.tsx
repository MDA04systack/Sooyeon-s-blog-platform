        ...
        <div className="flex h-screen flex-col overflow-hidden bg-[#0f172a] text-slate-300">
            ...
            <header className="flex h-14 shrink-0 items-center justify-between border-b border-slate-800 px-4">
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex items-center gap-3">
                        <span className="text-sm font-semibold text-white">글 수정</span>
                ...
                <div className="flex items-center gap-3">
                    ...
                    >
                        {isSaving ? <div className="h-4 w-4 animate-spin rounded-full border-2 border-slate-400 border-t-transparent" /> : (
                    ...
                    <div className="relative">
                        ...
                        {showStatusMenu && (
                            <>
                                ...
                                <div className="absolute right-0 top-full mt-2 w-44 rounded-xl border border-slate-700 bg-slate-800 p-1 shadow-xl z-20">
                                    <button
            ...
            <div className="flex h-10 shrink-0 items-center justify-between border-b border-slate-800 bg-slate-900/50 px-4">
                <div className="flex items-center gap-1">
                    <button onClick={() => insertText('**', '**')} className="flex h-8 w-8 items-center justify-center rounded text-slate-400 hover:bg-slate-800 hover:text-white" title="Bold"><span className="font-bold">B</span></button>
                    <button onClick={() => insertText('*', '*')} className="flex h-8 w-8 items-center justify-center rounded text-slate-400 hover:bg-slate-800 hover:text-white" title="Italic"><span className="italic">I</span></button>
                    <button onClick={() => insertText('~~', '~~')} className="flex h-8 w-8 items-center justify-center rounded text-slate-400 hover:bg-slate-800 hover:text-white" title="Strikethrough"><span className="line-through">S</span></button>
                    <div className="mx-2 h-4 w-px bg-slate-700" />
                    <button onClick={() => insertText('## ')} className="flex h-8 w-8 items-center justify-center rounded text-slate-400 hover:bg-slate-800 hover:text-white font-bold" title="Heading 2">H2</button>
                    <button onClick={() => insertText('### ')} className="flex h-8 w-8 items-center justify-center rounded text-slate-400 hover:bg-slate-800 hover:text-white font-bold" title="Heading 3">H3</button>
                    <div className="mx-2 h-4 w-px bg-slate-700" />
                    <button onClick={() => insertText('> ')} className="flex h-8 w-8 items-center justify-center rounded text-slate-400 hover:bg-slate-800 hover:text-white text-lg font-serif font-bold" title="Quote">"</button>
            ...
            <div className="flex flex-1 overflow-hidden">
                ...
                <div className="w-1/2 overflow-y-auto p-8 lg:px-12">
                    ...
                    <h1 className="mb-8 text-4xl font-bold text-white leading-tight">{title || '제목을 입력하세요'}</h1>
            ...
            <footer className="flex h-8 shrink-0 items-center justify-between border-t border-slate-800 bg-[#0f172a] px-4 text-xs text-slate-500">
                ...
                <div className="flex items-center gap-2">
                    <span className={`h-2 w-2 rounded-full ${status === 'published' ? 'bg-emerald-500' : status === 'private' ? 'bg-amber-500' : 'bg-slate-600'}`} />
                    {statusLabel[status]}
                </div>
            </footer>
        </div>
