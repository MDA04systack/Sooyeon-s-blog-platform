            ...
            <div className="mx-auto flex max-w-7xl items-center gap-4 px-6 py-3">
                ...
                <div className="ml-auto flex items-center gap-3">
                    ...
                    {user ? (
                        <>
                            {isAdmin && (
                                <Link href="/admin" className="flex items-center gap-1.5 rounded-full px-3 py-1.5 text-sm font-medium text-amber-500 hover:text-amber-400 bg-amber-500/10 hover:bg-amber-500/20 transition">
