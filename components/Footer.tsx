...
export default function Footer() {
    return (
        <footer className="mt-16 border-t border-[var(--border)] bg-[var(--bg-primary)]">
            <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-8">
                ...
                <Link href="/" className="flex items-center gap-2">
                    ...
                    <div className="flex flex-col -ml-0.5">
                        ...
                        <span className="text-[8px] font-light text-[var(--text-muted)] tracking-wider mt-0.5 uppercase">
                ...
                <div className="flex items-center gap-4">
                    {/* GitHub */}
                    <a
                        href="https://github.com/MDA04systack/Sooyeon-s-blog-platform"
                        target="_blank"
